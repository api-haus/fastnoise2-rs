...
#[deprecated(since = "0.4.0", note = "Use `supersimplex()` instead - OpenSimplex2 was renamed to SuperSimplex in FastNoise2")]
pub fn opensimplex2() -> GeneratorWrapper<SuperSimplex> {
  SuperSimplex::default().into()
}

#[deprecated(since = "0.4.0", note = "Use `supersimplex()` instead - OpenSimplex2S was renamed to SuperSimplex in FastNoise2")]
pub fn opensimplex2s() -> GeneratorWrapper<SuperSimplex> {
  SuperSimplex::default().into()
}
